  ...
  return (
    <div className="min-h-screen italic font-black uppercase bg-white">
      ...
      {/* =============================================
          ...
          ============================================= */}
      <div className="folha-container mt-4 mb-10" style={{maxWidth:"1100px", margin:"16px auto 40px auto", padding:0}}>

        {/* CABEÇALHO INSTITUCIONAL */}
        <div style={{width:"100%", display:"block", marginBottom:"8px", borderBottom:"2px solid #d1d5db"}}>
          <img
